...
import { getAppBaseUrl, getAppName, getGithubUrl, getTwitterUrl, getAuthorName } from 'lib/config';
...
export default function WelcomeEmail() {
	return (
		<Html>
			<Tailwind>
				<Head />
				<Preview>Welcome to {getAppName()}</Preview>
				<Body className="bg-white my-auto mx-auto font-sans">
					<Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
						...
						<Text className="text-black text-[14px] leading-[24px]">
							Hi, I{"'"}m {getAuthorName()}, creator of {getAppName()}, an open-source app to deliver financial clarity through
						...
						<Text className="m-1">
							...
							to know how its done in {getAppName()}.
						</Text>
						<Text className="m-1">
							2. Star our{' '}
